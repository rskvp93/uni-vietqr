...
describe('decodeZaloPayQR', () => {
  it('should handle missing optional fields gracefully', () => {
    const qrCode = '0002010102113804ZALO3900'; // QR code with only appId
    const result = decodeZaloPayQR(qrCode);

    
  });

  it('should decode all fields correctly when present', () => {
    const qrCode = '0002010102113804ZALO3906TRANS1544.5062Test Description';
    const result = decodeZaloPayQR(qrCode);
